      ...
      <div className="container flex flex-col items-center h-full mx-auto xl:flex-row gap-x-6">
        <div className="flex flex-col justify-center flex-1">
          ...
          <motion.p
            ...
            10 years ago, I began freelancing as developer. Since then, I've done remote work for agencies, counsulted for
            startups, and collaborated on digital products for bussiness and customer use.
          </motion.p>
          <motion.div
        ...
        <motion.div
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  } relative capitalize cursor-pointer xl:text-lg after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0`}
          ...
          <div className="flex flex-col items-center py-2 xl:py-6 gap-y-2 xl:gap-y-4 xl:items-start">
            {aboutData[index].info.map((item, itemIndex) => {
              return (
                <div key={itemIndex} className="flex flex-col items-center flex-1 text-white/60 md:flex-row max-w-max gap-x-2">
